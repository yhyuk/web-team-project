	...
	<%@ include file="/inc/header.jsp" %>
        ...
        <div class="section-padding2">
            <div class="container">
				...
				<!-- 글 작성 양식 -->
				<form method="POST" action="/rural/community/addok.do" enctype="multipart/form-data">
					...
					<div style="display:inline-block; margin-left: 300px;">
						<button type="submit" class="btn btn-success" style="text-align: right;">글쓰기</button>
