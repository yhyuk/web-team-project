...
<% 
	...
	String confmKey = "U01TX0FVVEgyMDIxMDczMDAwNDEyMDExMTQ2OTQ="; // 검색API 승인키
...
<script type="text/javascript" src="<%= request.getContextPath() %>/assets/js/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/assets/css/addrlink.css">
