...
<style>
	...
	#isEnd, #totalPerson, #sido, #gugun {
		width: 150px;
		display: inline-block;
	}
	
	#phoneNum, #cropInfo, #pay, #tel {
		width: 200px;
		display: inline-block;
	}
	...
	#tbl > tbody > tr:nth-child(1) > th:nth-child(1) {
		width: 200px;
	}
...
<body>
	...
	<div class="section-padding2">
		<div class="container">
			<h2 style="margin-bottom: 30px;"><strong>등록하기</strong></h2>
			<hr style="margin-top: 10px;">
			<form method="POST" action="/rural/worker/addok.do">
				<table class="table table-bordered" id="tbl">
					<tr>
						...
						<th>상태</th>
						<td><select class="form-control" name="isEnd" id="isEnd" required disabled>
					...
					<tr>
						...
						<td><input type="text" name="tel" id="tel"
							class="form-control" maxlength="13" required></td>
						<th>작업종료일</th>
						<td>
					...
					<tr>
						<th>근무지역</th>
						<td><select name="sido" id="sido" class="form-control"></select>
							<select name="gugun" id="gugun" class="form-control"></select></td>
						<th>경력</th>
						<td>
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="isCareer"
									name="isCareer"> <label class="form-check-label"
					...
					<tr>
						...
						<td><input type="number" name="totalPerson" id="totalPerson"
							class="form-control" min="1"> <span>명</span></td>
						<th>구인연령대</th>
						<td>
							<div>
								<input type="number" name="minAge" id="minAge"
									class="form-control" min="10" step="10"><span>대 ~ </span> <input
									type="number" name="maxAge" id="maxAge" class="form-control"
									min="10" step="10"><span>대</span>
							</div>
						</td>
					</tr>
					<tr>
						<th>작물 정보</th>
						<td colspan="3">
						<select class="form-control" name="cropInfo" id="cropInfo">
								<option>선택</option>
					...
					<tr>
						...
						<td><input type="number" name="pay" id="pay"
							class="form-control" min="0"><span> 원</span></td>
						<th>상세 주소</th>
						<td>
				...
				<div class="btns" id="btns" style="text-align: center">
					<button class="btn btn-success" id="applybtn" type="submit">등록하기</button>
